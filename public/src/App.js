...
function App() {
  ...
  // L'URL de base de ton API Render (ou autre)
  // Tu peux la mettre en variable d’environnement Vercel (process.env.REACT_APP_API_URL)
  // ou la mettre en dur ici :
  const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://facturation-saas.onrender.com';

  const handleGenerateInvoice = async () => {
    try {
      // Requête POST à /generate-invoice
